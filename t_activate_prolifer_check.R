...
clean_gene_ann$`T cell activation` <- ifelse(str_detect(clean_gene_ann$Annotation, "T-cell activation"), "+", "-")
clean_gene_ann$`T cell proliferation` <- ifelse(str_detect(clean_gene_ann$Annotation, "T-cell proliferation"), "+", "-")
clean_gene_ann$`T cell differentiation` <- ifelse(str_detect(clean_gene_ann$Annotation, "T-cell differentiation"), "+", "-")
gene_ann <- clean_gene_ann[,str_detect(colnames(clean_gene_ann), "T cell")]
